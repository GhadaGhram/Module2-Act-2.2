...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 19 avr. 2022 à 14:53
...
(6, 'ines Masmoudi', 99737515, 'classique', 'cinema');
...
INSERT INTO `produits` (`idproduit`, `nomproduit`, `type`, `marque`, `réference_au_fournisseur`, `prix`) VALUES
(1, 'groupe de chant', 'act musicale', 'adulte', 'conservatoire municipale', 200),
(2, 'corale', 'act musicale', 'enfant', 'conservatoire municipale', 200),
(3, 'bluepasssport', 'act sportive', 'adulte', 'california gym', 200),
(4, 'islandkids', 'act sportive', 'enfant', 'california gym', 200),
(5, 'smartADSL', 'service', 'particulier', 'topnet', 200);
COMMIT;
